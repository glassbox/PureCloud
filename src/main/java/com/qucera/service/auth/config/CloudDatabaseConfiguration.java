package com.qucera.service.auth.config;
...
@Configuration
@EnableMongoRepositories("com.qucera.service.auth.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.qucera.service.auth.config.dbmigrations");
